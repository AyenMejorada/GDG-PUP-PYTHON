My notes: In this assignment, I created a python dictionary that could add another key value, update, and delete. It is quite similar to the assignment 5, but this assignment is simpler.
